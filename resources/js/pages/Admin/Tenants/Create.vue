                        ...
                        <div class="grid gap-4">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2">
                                <div>
                                    ...
                                    <input v-model="form.email" type="email" class="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm focus:border-primary focus:outline-none" />
                                ...
                                <div>
                                    ...
                                    <input v-model="form.phone" type="tel" class="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm focus:border-primary focus:outline-none" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-lg border border-border bg-card p-6 shadow-sm">
                        ...
                        <div class="grid gap-4">
                            <div>
                                ...
                                <input v-model="form.admin_name" type="text" class="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm focus:border-primary focus:outline-none" />
                            ...
                            <div>
                                ...
                                <input v-model="form.admin_email" type="email" class="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm focus:border-primary focus:outline-none" />
                            ...
                            <div>
                                ...
                                <input v-model="form.admin_password" type="password" class="w-full rounded-lg border border-border bg-background px-4 py-2.5 text-sm focus:border-primary focus:outline-none" />
